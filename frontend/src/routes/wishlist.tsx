    ...
    <div className="max-w-5xl mx-auto px-4 py-6 sm:px-6 lg:px-8 space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">Prioritised things you're saving up for.</p>
        </div>
      ...
      {plan && plan.items.length > 0 && (
        <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-gray-200 dark:border-slate-800 shadow-sm">
          <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-slate-800">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Purchase plan</h2>
